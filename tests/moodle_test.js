...
casper.test.begin('Log into Moodle and check a sample course for basic functionality', 39, function suite(test) {
	...
	casper.thenClick({ type: 'xpath', path: "//a/span[contains(text(),'Test Text File')][1]"}, function() {
		...
		// Check for  page content
		this.test.assertTextExists("Nothing was greater there than the quality of robust love", "Sample text appears on the test text file");
	...
	casper.thenClick({ type: 'xpath', path: "//a[contains(text(),'Moodle Home')][1]"}, function() {
